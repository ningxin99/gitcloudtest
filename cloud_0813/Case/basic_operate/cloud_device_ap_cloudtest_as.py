...
class DeviceAp(unittest.TestCase):
    ...
    def test01_check_online_AP(self):
        ...
        try:
            ...
            while True:
                ...
                if state_ap == 'Synchronized':
                    print(u"AP配置同步成功")
                    time_ap_Synchronized = time.time()
                    t = int((time_ap_Synchronized - time_ap_online) / 60)
                    break
    ...
    def test02_ap_deliver(self):
        ...
        try:
            ...
            self.operate.find_elem(add_device_Synchronized)
        except Exception as e:
            print (e)
            ...
            self.operate.click_elem(key_OK)
            time.sleep(5)
            if self.operate.find_elem(device_config_state).text == "Not Synchronized":
    ...
    def test05_ap_detail_radio(self):
        ...
        time.sleep(2)
        self.operate.click_elem(add_device_device_info.format(add_device_alert_input_sn))
        js = "var q=document.getElementById('svgBlockDiv').scrollTop=150"
