...
for _ in range(5000000):
    ...
    monthTime = random.randint(11,12)
    if monthTime == 12:
        dayTime = random.randint(1,2)
    ss["_id"] = ObjectId(id)
    ss["mac"] = mac
    ss["onlineTime"] = datetime(2019,monthTime,dayTime,onlineTime,00,29,0)
    ss["updateTime"] = datetime(2019,monthTime,dayTime,updateTime,00,29,0)
    ss["offlineTime"] = datetime(2019,monthTime,dayTime,offlineTime,00,29,0)
